            ...
            <aside class="flex min-h-full w-72 flex-col border-r border-slate-100 bg-white px-6 py-8">
                ...
                <ul class="menu w-full gap-2 p-0 font-medium text-slate-600">
                    ...
                    @if ($user->is_admin)
                        {{-- METODE AHP --}}
                        <li>
                            <details {{ Request::is('criteria*', 'comparison-matrix*', 'ahp-test*') ? 'open' : '' }}>
                                <summary
                ...
                <div class="mt-auto rounded-2xl border border-slate-100/50 bg-slate-50 p-4">
                    <p class="text-[10px] font-medium text-slate-400">Sistem Informasi SPK AHP + TOPSIS</p>
                    <p class="text-xs font-bold uppercase text-slate-700">v1.0.0 - 2026</p>
                </div>
            </aside>
        </div>
    </div>
