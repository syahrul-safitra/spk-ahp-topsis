...
@section("content")
    <div class="mx-auto space-y-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-black tracking-tight text-slate-800">Tambah User</h2>
                <p class="text-sm font-medium text-slate-500">Daun barkan pengguna baru ke dalam sistem.</p>
            </div>
        </div>
            ...
            <form action="{{ url("user") }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-12 gap-x-6 gap-y-5">
                    ...
                    <div class="col-span-12">
                        <div class="form-control w-full">
                            <label class="label mb-1 px-1">
                                <span class="text-[11px] font-black uppercase tracking-widest text-slate-400">Password
                                    Sementara</span>
                            </label>
                            ...
                            <p class="mt-3 flex items-center gap-2 px-1 text-[10px] font-bold italic text-slate-400">
                                ...
                                Password akan di-enkripsi secara otomatis oleh sistem.
                            </p>
                            @error("password")
                                <span class="mt-1 px-1 text-xs font-bold text-rose-500">{{ $message }}</span>
                            @enderror
