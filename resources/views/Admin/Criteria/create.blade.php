                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" value="{{ old('nama') }}" placeholder="Contoh: Harga, Jarak, Fasilitas"
                                    autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="atribut" class="form-select @error('tipe') is-invalid @enderror">
                                    ...
                                    <option value="benefit" {{ old('atribut') == 'benefit' ? 'selected' : '' }}>
                                        Benefit (semakin besar semakin baik)
                                    </option>
                                    <option value="cost" {{ old('atribut') == 'cost' ? 'selected' : '' }}>
